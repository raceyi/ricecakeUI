import { NavController,AlertController,Platform ,Events,App,LoadingController} from 'ionic-angular';
  ...
  constructor(public http: HttpClient,
    ...
    this.platform.ready().then(() => {
         ...
         */
            ...
            this.refresh("menu").then(()=>{
                this.refresh("order").then(()=>{
                     this.refresh("carrier").then(()=>{
                            this.refresh("produce").then(()=>{
  ...
  refresh(tablename:string){ // 서버로 부터 최신 정보를 가져온다.
        return new Promise((resolve,reject)=>{  
            ...
            if(tablename=="order"){
                ...
                /* Android의 문제로 asynchronous하게 진행함 
                this.serverProvider.getOrdersInTrash().then((orders)=>{
                    this.ngZone.run(()=>{
                    this.trashList=orders;
                    this.trashList.sort(function(a,b){
...
/////////////////////////////////////////////////////
  ...
  sortOrdersInputTime(){
    ...
    print(type){
        ...
        this.printer.print(page).then((output)=>{
