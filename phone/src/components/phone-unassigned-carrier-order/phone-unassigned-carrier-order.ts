...
/**
 * Generated class for the PhoneUnassignedCarrierOrderComponent component.
 *
 * See https://angular.io/api/core/Component for more info on Angular
 * Components.
 */
@Component({
  selector: 'phone-unassigned-carrier-order',
  templateUrl: 'phone-unassigned-carrier-order.html'
})
export class PhoneUnassignedCarrierOrderComponent {
