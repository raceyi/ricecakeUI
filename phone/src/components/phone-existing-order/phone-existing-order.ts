...
/**
 * Generated class for the PhoneExistingOrderComponent component.
 *
 * See https://angular.io/api/core/Component for more info on Angular
 * Components.
 */
@Component({
  selector: 'phone-existing-order',
  templateUrl: 'phone-existing-order.html'
})
export class PhoneExistingOrderComponent {
 // ipad와 mobile버전이 동일해야만 한다. 
